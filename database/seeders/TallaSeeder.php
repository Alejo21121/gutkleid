...
class TallaSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('tallas')->insert([
            ['id_producto' => 1, 'talla' => 'XS', 'cantidad' => 9],
            ['id_producto' => 1, 'talla' => 'S', 'cantidad' => 9],
            ['id_producto' => 1, 'talla' => 'M', 'cantidad' => 10],
            ['id_producto' => 1, 'talla' => 'L', 'cantidad' => 19],

            ['id_producto' => 2, 'talla' => '28', 'cantidad' => 7],
            ['id_producto' => 2, 'talla' => '30', 'cantidad' => 7],
            ['id_producto' => 2, 'talla' => '32', 'cantidad' => 6],
            ['id_producto' => 2, 'talla' => '34', 'cantidad' => 7],
            
            ['id_producto' => 3, 'talla' => 'XS', 'cantidad' => 8],
            ['id_producto' => 3, 'talla' => 'S', 'cantidad' => 8],
            ['id_producto' => 3, 'talla' => 'M', 'cantidad' => 8],
            ['id_producto' => 3, 'talla' => 'L', 'cantidad' => 8],

            ['id_producto' => 4, 'talla' => 'XS', 'cantidad' => 5],
            ['id_producto' => 4, 'talla' => 'S', 'cantidad' => 5],
            ['id_producto' => 4, 'talla' => 'M', 'cantidad' => 5],
            ['id_producto' => 4, 'talla' => 'L', 'cantidad' => 5],

            ['id_producto' => 5, 'talla' => 'XS', 'cantidad' => 4],
            ['id_producto' => 5, 'talla' => 'S', 'cantidad' => 4],
            ['id_producto' => 5, 'talla' => 'M', 'cantidad' => 4],
