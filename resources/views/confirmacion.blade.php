...
<header class="cabeza">
    <nav class="barras">
        ...
        <div class="nav-center">
            <a href="/"><div class="logo"><img src="{{ asset('IMG/LOGO3.PNG') }}" alt="Logo"></div></a>
        </div>
        <div class="nav-right">
    ...
    <div class="containercar">
        ...
        <form id="envio-form" action="{{ route('envio.guardar') }}" method="POST">
            ...
            <table class="table table-bordered mt-4">
                <tr><th>Documento</th><td>{{ optional($persona)->documento ?? '—' }}</td></tr>
                <tr><th>Fecha de nacimiento</th><td>{{ optional($persona)->fecha_nacimiento ?? '—' }}</td></tr>
                <tr><th>Nombres</th><td>{{ optional($persona)->nombres ?? '—' }}</td></tr>
                <tr><th>Apellidos</th><td>{{ optional($persona)->apellidos ?? '—' }}</td></tr>
                <tr><th>Correo</th><td>{{ optional($persona)->correo ?? '—' }}</td></tr>
                <tr><th>Teléfono</th><td>{{ optional($persona)->telefono ?? '—' }}</td></tr>
                <tr><th>Dirección</th><td>{{ $direccionMostrada }}</td></tr>
                <tr>
