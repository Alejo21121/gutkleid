            ...
            <tr class="pedido-detalle-row">
              <td colspan="6">
                <div class="pedido-detalle p-3 border rounded" id="pedido{{ $factura->id_factura_venta }}">
                  ...
                  <table class="table table-sm align-middle">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ${{ number_format(round((($detalle->subtotal + $detalle->iva) / $detalle->cantidad), -3), 0, ',', '.') }}
                        </td>
                  ...
                  <!-- Totales -->
                  <table class="table table-bordered w-50 ms-auto mt-4">
                    <tbody>
                      ...
                      <tr class="table-primary">
                        ...
                        <td class="text-end fw-bold">
                          ${{ number_format(round($factura->total, -3), 0, ',', '.') }}
                        </td>
                      </tr>
                    </tbody>
                  </table>
